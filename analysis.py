...
def mask_test_set(latent_component_indices, vae, x_test, x_train, subject):
    ...
    _, _, z_train_no_blinks = vae.encoder(x_train_no_blinks, training=False)
...
def mask_test_set_reversed(latent_component_indices, vae, x_test, subject):
    ...
    x_train_no_blinks = get_x_train_no_blinks(x_test, y_test)
    _, _, z = vae.encoder(x_train_no_blinks, training=False)
...
if __name__ == '__main__':
    ...
    mask_test_set(top_k_indices, vae, x_test, x_train, subject)  # maschera quelle specificate
    # mask_test_set_reversed(top_k_indices, vae, x_test, subject)  # maschera tutte tranne quelle specificate
