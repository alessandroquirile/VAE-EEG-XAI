...
class Encoder(keras.Model):
    ...
    def __init__(self, latent_dimension, input_shape):
        ...
        self.conv_block2 = layers.Conv2D(64, 3, 2, "same", activation="relu")
...
class Decoder(keras.Model):
    ...
    def __init__(self):
        ...
        self.deconv3 = layers.Conv2DTranspose(1, 3, (1, 1), "same", activation="relu")
...
if __name__ == '__main__':
    # Encoder
    latent_dim = 2
    encoder = Encoder(latent_dim, (28, 28, 1))
    ...
    mnist_digits = np.expand_dims(mnist_digits, -1).astype("float32") / 255  # (70000, 28, 28, 1)
    ...
    plt.title(f"Reconstructed image {image_index}, latent_dim = {latent_dim}, epochs = {epochs}, "
